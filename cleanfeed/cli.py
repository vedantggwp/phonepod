"""Command-line interface for cleanfeed.

Usage: cleanfeed input.m4a output.wav
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="cleanfeed",
        description="cleanfeed — Local AI audio restoration. Phone recording → podcast quality.",
    )
    parser.add_argument(
